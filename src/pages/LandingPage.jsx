            ...
            <div className="col-md-4">
              <div className="card shadow-sm border-0 p-4 h-100 bg-light rounded-4">
                ...
                <p className="text-muted small mb-0">
                  Choose from in-demand career dreams tailored to tech, design, business, and public service.
                </p>
              </div>
            </div>
            <div className="col-md-4">
      ...
      <section className="py-5 bg-light border-top border-bottom">
        <div className="container">
          ...
          <div className="text-center mt-4">
            <Link to="/login" className="btn btn-primary btn-lg rounded-pill px-5 py-3 fw-bold shadow-sm">
              Get Started
            </Link>
          </div>
        </div>
